...
$$
PL_{actual} = \sum_{i=0}^n(\sum_{x=X} ( P_{x,i} • SI_{x,i} ) + SI_{x,i} + \sum_{w=W} SI_{w,i} + ( SI_{w,i} • O_{cost} ) )
$$

$$
PL_{actual} = T_0 + \sum_{i=0}^n(\sum_{x=X} ( P_{x,i} • SI_{x,i} ) + SI_{x,i} - ( O_{cost} • SI_{x,i} ) + \sum_{w=W} SI_{w,i} + ( SI_{w,i} • O_{cost} ) )
$$
